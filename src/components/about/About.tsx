    ...
    return(
        ...
        <h2>About Me</h2>
            ...
            <div className="journey-content">
                <p>My path to software development has been anything but linear. In school, my love for mathematics and physics led me to pursue a degree in Mathematical Physics, followed by a Masters and PhD in Particle Physics.</p>
                ...
                <div className="journey-highlight">
                    ...
                    <p>It was during my doctoral research that I first encountered programming,learning C++ for data analysis, alongside Fortran, Bash, and Perl scripting to manage computational jobs. These tools were merely instruments for scientific discovery, not ends in themselves.
                      After several years in physics research, I pivoted to education, experiencing technology.from a completely different perspective, as a user rather than a creator.</p>
                </div>
